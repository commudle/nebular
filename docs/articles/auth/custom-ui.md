...
import { NbAlertModule, NbButtonModule, NbCheckboxModule, NbInputModule } from '@commudle/theme';
...
import { NbAuthComponent } from '@commudle/auth'; // <---
...
import { NbLoginComponent } from '@commudle/auth';
